...
function (_Component) {
  ...
  function Legend() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateLegend", function (config) {
  ...
  _createClass(Legend, [{
    ...
    value: function componentDidMount() {
      ...
      this.updateLegend(_objectSpread({}, rest));
    }
  }, {
