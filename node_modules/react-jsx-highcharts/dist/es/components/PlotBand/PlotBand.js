...
function (_Component) {
  ...
  function PlotBand(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PlotBand).call(this, props));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getPlotBandConfig", function () {
...
_defineProperty(PlotBand, "defaultProps", {
  id: uuid
});
