...
function (_Component) {
  ...
  function PlotBandLabel() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PlotBandLabel)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getLabelProps", function (props) {
      return pickBy(props, function (value, propName) {
        return PlotBandLabel.labelProps.indexOf(propName) > -1;
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updatePlotBandLabel", function (config) {
  ...
  _createClass(PlotBandLabel, [{
    ...
    value: function componentDidMount() {
      ...
      this.updatePlotBandLabel(_objectSpread({
        text: text
      }, rest));
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      attempt(this.updatePlotBandLabel, _objectSpread({
        text: null
      }, rest));
    }
  }, {
...
_defineProperty(PlotBandLabel, "labelProps", ['text', 'align', 'rotation', 'style', 'textAlign', 'useHTML', 'verticalAlign', 'x', 'y']);
