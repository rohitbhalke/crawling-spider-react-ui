...
function (_Component) {
  ...
  function Title() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateTitle", function (config) {
  ...
  _createClass(Title, [{
    ...
    value: function componentDidMount() {
      ...
      this.updateTitle(_objectSpread({}, rest, {
        text: text
      }));
    }
  }, {
